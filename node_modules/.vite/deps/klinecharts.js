...
var IndicatorStore = (
  ...
  (function() {
    ...
    IndicatorStore2.prototype.setSeriesPrecision = function(precision) {
      this._instances.forEach(function(paneInstances) {
    ...
    if (coordinates.length > 0) {
      ...
      if (coordinates.length > 1 && isNumber(points[0].value) && isNumber(points[1].value)) {
        ...
        percents.forEach(function(percent) {
          ...
          var value = formatFoldDecimal(formatThousands((((_a2 = points[1].value) !== null && _a2 !== void 0 ? _a2 : 0) + valueDif_1 * percent).toFixed(precision.price), thousandsSeparator), decimalFoldThreshold);
...
function checkCoordinateOnLine(coordinate, line2) {
  var coordinates = line2.coordinates;
...
function drawLine(ctx, attrs, styles2) {
  ...
  if (length > 1) {
    var _a = styles2.style, style = _a === void 0 ? LineType.Solid : _a, smooth = styles2.smooth, _b = styles2.size, size = _b === void 0 ? 1 : _b, _c = styles2.color, color = _c === void 0 ? "currentColor" : _c, _d = styles2.dashedValue, dashedValue = _d === void 0 ? [2, 2] : _d;
    ctx.lineWidth = size;
  ...
  (function() {
    ...
    ChartStore2.prototype.setOptions = function(options) {
      if (isValid(options)) {
        ...
        if (isValid(styles2)) {
          if (isString(styles2)) {
            merge(this._styles, getStyles(styles2));
          } else {
    ...
    ChartStore2.prototype.addData = function(data, isFirstAdd, more) {
      return __awaiter(this, void 0, void 0, function() {
    ...
    ChartStore2.prototype.executeLoadDataCallback = function(params) {
      ...
      if (!this._loading && isValid(this._loadDataCallback) && (this._forwardMore && params.type === LoadDataType.Forward || this._backwardMore && params.type === LoadDataType.Backward)) {
        var cb = function(data, more) {
          ...
          _this.addData(dataList, false).then(function() {
          }).catch(function() {
          });
        };
        this._loading = true;
...
var Canvas = (
  ...
  (function() {
    ...
    Canvas2.prototype._resetPixelRatio = function(pixelWidth, pixelHeight, horizontalPixelRatio, verticalPixelRatio) {
      var _this = this;
...
function checkCoordinateOnCircle(coordinate, circle2) {
  var difX = coordinate.x - circle2.x;
  var difY = coordinate.y - circle2.y;
  var r = circle2.r;
...
function checkCoordinateOnPolygon(coordinate, polygon2) {
  var on = false;
  var coordinates = polygon2.coordinates;
...
function checkCoordinateOnRect(coordinate, rect2) {
  var x = rect2.x;
...
function drawRect(ctx, attrs, styles2) {
  ...
  var _a = styles2.style, style = _a === void 0 ? PolygonType.Fill : _a, _b = styles2.color, color = _b === void 0 ? "transparent" : _b, _c = styles2.borderSize, borderSize = _c === void 0 ? 1 : _c, _d = styles2.borderColor, borderColor = _d === void 0 ? "transparent" : _d, _e = styles2.borderStyle, borderStyle = _e === void 0 ? LineType.Solid : _e, _f = styles2.borderRadius, r = _f === void 0 ? 0 : _f, _g = styles2.borderDashedValue, borderDashedValue = _g === void 0 ? [2, 2] : _g;
  if ((style === PolygonType.Fill || styles2.style === PolygonType.StrokeFill) && (!isString(color) || !isTransparent(color))) {
    ctx.fillStyle = color;
    ctx.beginPath();
    ctx.moveTo(x + r, y);
...
function checkCoordinateOnText(coordinate, attrs, styles2) {
  var _a = getTextRect(attrs, styles2), x = _a.x, y = _a.y, width = _a.width, height = _a.height;
  return coordinate.x >= x && coordinate.x <= x + width && coordinate.y >= y && coordinate.y <= y + height;
}
function drawText(ctx, attrs, styles2) {
  ...
  var rect2 = getTextRect(attrs, styles2);
  drawRect(ctx, rect2, __assign(__assign({}, styles2), { color: styles2.backgroundColor }));
  ctx.textAlign = "left";
  ctx.textBaseline = "top";
  ctx.font = createFont(size, weight, family);
  ctx.fillStyle = color;
  ctx.fillText(text2, rect2.x + paddingLeft, rect2.y + paddingTop, rect2.width - paddingLeft - paddingRight);
}
var text = {
  name: "text",
  checkEventOn: function(coordinate, attrs, styles2) {
    return checkCoordinateOnText(coordinate, attrs, styles2);
  },
  draw: function(ctx, attrs, styles2) {
...
function checkCoordinateOnArc(coordinate, arc2) {
  if (Math.abs(getDistance(coordinate, arc2) - arc2.r) < DEVIATION) {
    var r = arc2.r, startAngle = arc2.startAngle, endAngle = arc2.endAngle;
    var startCoordinateX = r * Math.cos(startAngle) + arc2.x;
    var startCoordinateY = r * Math.sin(startAngle) + arc2.y;
    var endCoordinateX = r * Math.cos(endAngle) + arc2.x;
    var endCoordinateY = r * Math.sin(endAngle) + arc2.y;
    return coordinate.x <= Math.max(startCoordinateX, endCoordinateX) + DEVIATION && coordinate.x >= Math.min(startCoordinateX, endCoordinateX) - DEVIATION && coordinate.y <= Math.max(startCoordinateY, endCoordinateY) + DEVIATION && coordinate.y >= Math.min(startCoordinateY, endCoordinateY) - DEVIATION;
  }
  return false;
}
        ...
        if (indicator.visible) {
          ...
          if (!isCover) {
            ...
            _this.eachChildren(function(data, barSpace) {
              ...
              var prevIndicatorData = (_a2 = result_1[dataIndex - 1]) !== null && _a2 !== void 0 ? _a2 : {};
...
var IndicatorTooltipView = (
  ...
  (function(_super) {
    ...
    function IndicatorTooltipView2() {
      var _this = _super !== null && _super.apply(this, arguments) || this;
      _this._boundIconClickEvent = function(currentIcon, iconId) {
        return function() {
          var pane = _this.getWidget().getPane();
          pane.getChart().getChartStore().getActionStore().execute(ActionType.OnTooltipIconClick, __assign(__assign({}, currentIcon), { iconId }));
          return true;
        };
      };
      _this._boundIconMouseMoveEvent = function(currentIconInfo, iconId) {
        return function() {
          var pane = _this.getWidget().getPane();
          var tooltipStore = pane.getChart().getChartStore().getTooltipStore();
          tooltipStore.setActiveIcon(__assign(__assign({}, currentIconInfo), { iconId }));
          return true;
        };
      };
      return _this;
    ...
    IndicatorTooltipView2.prototype.drawImp = function(ctx) {
      ...
      if (isValid(crosshair.kLineData)) {
        ...
        var defaultStyles = chartStore.getStyles().indicator;
        this.drawIndicatorTooltip(ctx, pane.getId(), chartStore.getDataList(), crosshair, activeIcon, indicators2, customApi, thousandsSeparator, decimalFoldThreshold, bounding, defaultStyles);
      }
    };
    IndicatorTooltipView2.prototype.drawIndicatorTooltip = function(ctx, paneId, dataList, crosshair, activeTooltipIconInfo, indicators2, customApi, thousandsSeparator, decimalFoldThreshold, bounding, styles2, top) {
      var _this = this;
      ...
      if (this.isDrawTooltip(crosshair, tooltipStyles)) {
        ...
        indicators2.forEach(function(indicator) {
          var _a = _this.getIndicatorTooltipData(dataList, crosshair, indicator, customApi, thousandsSeparator, decimalFoldThreshold, styles2), name = _a.name, calcParamsText = _a.calcParamsText, values = _a.values, icons = _a.icons;
          ...
          if (nameValid || valuesValid) {
            ...
            var _c = __read(_this.drawStandardTooltipIcons(ctx, bounding, { paneId, indicatorName: indicator.name, iconId: "" }, activeTooltipIconInfo, leftIcons, x_1, y_1, prevRowHeight_1), 4), leftIconsNextStartX = _c[0], leftIconsNextStartY = _c[1], leftIconsLastRowHeight = _c[2], leftIconsIncreaseHeight = _c[3];
            ...
            if (nameValid) {
              ...
              var _d = __read(_this.drawStandardTooltipLabels(ctx, bounding, [{ title: { text: "", color: tooltipTextStyles_1.color }, value: { text: text2, color: tooltipTextStyles_1.color } }], x_1, y_1, prevRowHeight_1, tooltipTextStyles_1), 4), nameStartX = _d[0], nameStartY = _d[1], nameLastRowHeight = _d[2], nameIncreaseHeight = _d[3];
              x_1 = nameStartX;
              y_1 = nameStartY;
              height += nameIncreaseHeight;
              prevRowHeight_1 = nameLastRowHeight;
            }
            var _e = __read(_this.drawStandardTooltipIcons(ctx, bounding, { paneId, indicatorName: indicator.name, iconId: "" }, activeTooltipIconInfo, middleIcons, x_1, y_1, prevRowHeight_1), 4), middleIconsNextStartX = _e[0], middleIconsNextStartY = _e[1], middleIconsLastRowHeight = _e[2], middleIconsIncreaseHeight = _e[3];
            ...
            var _g = __read(_this.drawStandardTooltipIcons(ctx, bounding, { paneId, indicatorName: indicator.name, iconId: "" }, activeTooltipIconInfo, rightIcons, x_1, y_1, prevRowHeight_1), 4), rightIconsNextStartY = _g[1], rightIconsLastRowHeight = _g[2], rightIconsIncreaseHeight = _g[3];
            x_1 = 0;
    ...
    IndicatorTooltipView2.prototype.drawStandardTooltipIcons = function(ctx, bounding, currentIcon, activeIcon, icons, startX, startY, prevRowHeight) {
      var _this = this;
      var x = startX;
      var y = startY;
      var width = 0;
      ...
      if (icons.length > 0) {
        icons.forEach(function(icon) {
          var marginLeft = icon.marginLeft, marginTop = icon.marginTop, marginRight = icon.marginRight, marginBottom = icon.marginBottom, paddingLeft = icon.paddingLeft, paddingTop = icon.paddingTop, paddingRight = icon.paddingRight, paddingBottom = icon.paddingBottom, size = icon.size, fontFamily = icon.fontFamily, text2 = icon.icon;
          ctx.font = createFont(size, "normal", fontFamily);
          width += marginLeft + paddingLeft + ctx.measureText(text2).width + paddingRight + marginRight;
        ...
        icons.forEach(function(icon) {
          ...
          (_a = _this.createFigure({
            name: "text",
            attrs: { text: text2, x, y: y + marginTop },
            styles: {
              paddingLeft,
              paddingTop,
              paddingRight,
          ...
          x += paddingLeft + ctx.measureText(text2).width + paddingRight + marginRight;
        });
      }
      return [x, y, Math.max(prevRowHeight, rowHeight), increaseHeight];
    };
    IndicatorTooltipView2.prototype.drawStandardTooltipLabels = function(ctx, bounding, labels, startX, startY, prevRowHeight, styles2) {
      var _this = this;
      var x = startX;
      var y = startY;
      var rowHeight = 0;
      ...
      if (labels.length > 0) {
        ...
        labels.forEach(function(data) {
          ...
          if (title.text.length > 0) {
            (_a = _this.createFigure({
              name: "text",
              attrs: { x, y: y + marginTop_1, text: title.text },
          ...
          (_b = _this.createFigure({
            name: "text",
            attrs: { x, y: y + marginTop_1, text: value.text },
      ...
      if (indicator.visible) {
        ...
        eachFigures(dataList, indicator, dataIndex, styles2, function(figure, figureStyles) {
          if (isString(figure.title)) {
            ...
            values.push({ title: { text: figure.title, color }, value: { text: formatFoldDecimal(formatThousands(value !== null && value !== void 0 ? value : tooltipStyles.defaultValue, thousandsSeparator), decimalFoldThreshold), color } });
          }
        });
      ...
      if (indicator.createTooltipDataSource !== null) {
        ...
        if (isValid(customValues) && indicator.visible) {
          ...
          customValues.forEach(function(data) {
            ...
            optimizedValues_1.push({ title, value });
          });
  ...
  (function(_super) {
    ...
    OverlayView2.prototype.drawImp = function(ctx) {
      ...
      overlays2.forEach(function(overlay2) {
        if (overlay2.visible) {
          _this._drawOverlay(ctx, overlay2, bounding, barSpace, precision, dateTimeFormat, customApi, thousandsSeparator, decimalFoldThreshold, defaultStyles, xAxis, yAxis, hoverInstanceInfo, clickInstanceInfo, timeScaleStore);
        }
      });
      var progressInstanceInfo = overlayStore.getProgressInstanceInfo();
      if (progressInstanceInfo !== null) {
...
var CandleTooltipView = (
  ...
  (function(_super) {
    ...
    CandleTooltipView2.prototype.drawImp = function(ctx) {
      ...
      if (isValid(crosshair.kLineData)) {
        ...
        if (candleStyles.tooltip.showType === TooltipShowType.Rect && indicatorStyles.tooltip.showType === TooltipShowType.Rect) {
          ...
          this._drawRectTooltip(ctx, dataList, indicators2, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, isDrawCandleTooltip, isDrawIndicatorTooltip, styles2, 0);
          ...
          this.drawIndicatorTooltip(ctx, paneId, dataList, crosshair, activeIcon, indicators2, customApi, thousandsSeparator, decimalFoldThreshold, bounding, indicatorStyles, top_1);
        } else if (candleStyles.tooltip.showType === TooltipShowType.Rect && indicatorStyles.tooltip.showType === TooltipShowType.Standard) {
          var top_2 = this.drawIndicatorTooltip(ctx, paneId, dataList, crosshair, activeIcon, indicators2, customApi, thousandsSeparator, decimalFoldThreshold, bounding, indicatorStyles, 0);
          var isDrawCandleTooltip = this.isDrawTooltip(crosshair, candleStyles.tooltip);
          this._drawRectTooltip(ctx, dataList, indicators2, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, isDrawCandleTooltip, false, styles2, top_2);
        } else {
          ...
          var isDrawIndicatorTooltip = this.isDrawTooltip(crosshair, indicatorStyles.tooltip);
          this._drawRectTooltip(ctx, dataList, indicators2, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, false, isDrawIndicatorTooltip, styles2, top_3);
        }
      }
    };
    CandleTooltipView2.prototype._drawCandleStandardTooltip = function(ctx, dataList, paneId, bounding, crosshair, activeTooltipIcon, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, styles2) {
      var _a, _b, _c;
      var tooltipStyles = styles2.tooltip;
      ...
      if (this.isDrawTooltip(crosshair, tooltipStyles)) {
        ...
        var values = this._getCandleTooltipData({ prev: (_b = dataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : null, current: crosshair.kLineData, next: (_c = dataList[dataIndex + 1]) !== null && _c !== void 0 ? _c : null }, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, styles2);
        var x = 0;
        var y = 0;
        var prevRowHeight = 0;
        var _d = __read(this.classifyTooltipIcons(tooltipStyles.icons), 3), leftIcons = _d[0], middleIcons = _d[1], rightIcons = _d[2];
        var _e = __read(this.drawStandardTooltipIcons(ctx, bounding, { paneId, indicatorName: "", iconId: "" }, activeTooltipIcon, leftIcons, x, y, 0), 4), leftIconsNextStartX = _e[0], leftIconsNextStartY = _e[1], leftIconsLastRowHeight = _e[2], leftIconsIncreaseHeight = _e[3];
        x = leftIconsNextStartX;
        y = leftIconsNextStartY;
        height += leftIconsIncreaseHeight;
        prevRowHeight = leftIconsLastRowHeight;
        var _f = __read(this.drawStandardTooltipIcons(ctx, bounding, { paneId, indicatorName: "", iconId: "" }, activeTooltipIcon, middleIcons, x, y, prevRowHeight), 4), middleIconsNextStartX = _f[0], middleIconsNextStartY = _f[1], middleIconsLastRowHeight = _f[2], middleIconsIncreaseHeight = _f[3];
        ...
        var _h = __read(this.drawStandardTooltipIcons(ctx, bounding, { paneId, indicatorName: "", iconId: "" }, activeTooltipIcon, rightIcons, x, y, prevRowHeight), 4), rightIconsNextStartX = _h[0], rightIconsNextStartY = _h[1], rightIconsLastRowHeight = _h[2], rightIconsIncreaseHeight = _h[3];
    ...
    CandleTooltipView2.prototype._drawRectTooltip = function(ctx, dataList, indicators2, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, isDrawCandleTooltip, isDrawIndicatorTooltip, styles2, top) {
      var _this = this;
      var _a, _b, _c, _d, _e;
      var candleStyles = styles2.candle;
      var indicatorStyles = styles2.indicator;
    ...
    CandleTooltipView2.prototype._getCandleTooltipData = function(data, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, styles2) {
      ...
      var labelValues = (_f = isFunction(tooltipStyles.custom) ? (_e = tooltipStyles.custom) === null || _e === void 0 ? void 0 : _e.call(tooltipStyles, data, styles2) : tooltipStyles.custom) !== null && _f !== void 0 ? _f : [
      ...
      return labelValues.map(function(_a2) {
        var _b2;
...
var XAxisView = (
  ...
  (function(_super) {
    ...
    XAxisView2.prototype.createAxisLine = function(bounding, styles2) {
      var correction = styles2.axisLine.size / 2;
      return {
        coordinates: [
          { x: 0, y: correction },
...
var ChartImp = (
  ...
  (function() {
    ...
    ChartImp2.prototype.getCandlePane = function() {
      return this._candlePane;
    };
    ...
    ChartImp2.prototype.applyNewData = function(data, more, callback) {
      ...
      this._chartStore.addData(data, true, more).then(function() {
      }).catch(function() {
      }).finally(function() {
    ...
    ChartImp2.prototype.applyMoreData = function(data, more, callback) {
      ...
      this._chartStore.addData(dataList, false, more !== null && more !== void 0 ? more : true).then(function() {
      }).catch(function() {
      }).finally(function() {
        callback === null || callback === void 0 ? void 0 : callback();
      });
    ...
    ChartImp2.prototype.updateData = function(data, callback) {
      ...
      this._chartStore.addData(data, false).then(function() {
      }).catch(function() {
      }).finally(function() {
        callback === null || callback === void 0 ? void 0 : callback();
      });
    ...
    ChartImp2.prototype.scrollByDistance = function(distance, animationDuration) {
      ...
      if (duration > 0) {
        timeScaleStore.startScroll();
        var startTime_1 = (/* @__PURE__ */ new Date()).getTime();
        var animation_1 = function() {
          var progress = ((/* @__PURE__ */ new Date()).getTime() - startTime_1) / duration;
    ...
    ChartImp2.prototype.zoomAtCoordinate = function(scale, coordinate, animationDuration) {
      ...
      if (duration > 0) {
        ...
        var startTime_2 = (/* @__PURE__ */ new Date()).getTime();
        var animation_2 = function() {
          var progress = ((/* @__PURE__ */ new Date()).getTime() - startTime_2) / duration;
          var finished = progress >= 1;
