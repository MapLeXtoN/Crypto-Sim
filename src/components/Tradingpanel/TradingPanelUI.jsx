                ...
                <div>
                    {tradeMode === 'futures' && amountType === 'usdt' && (
                        <div className="flex gap-2 mb-2 text-[10px]">
                            <button onClick={() => setFuturesInputMode('value')} className={`px-2 py-1 rounded transition-colors ${futuresInputMode === 'value' ? 'bg-[#474d57] text-[#f0b90b] border border-[#f0b90b]' : 'bg-[#2b3139] text-[#848e9c] border border-transparent'}`}>按價值買入</button>
                            <button onClick={() => setFuturesInputMode('cost')} className={`px-2 py-1 rounded transition-colors ${futuresInputMode === 'cost' ? 'bg-[#474d57] text-[#f0b90b] border border-[#f0b90b]' : 'bg-[#2b3139] text-[#848e9c] border border-transparent'}`}>按本金買入</button>
                        </div>
                    )}
